      ...
      <Toolbar sx={{ display: 'flex', justifyContent: 'space-between', width: '100%' }}>
        ...
        {user && (
          <Stack direction="row" spacing={2} alignItems="center">
            <Box textAlign="right">
              <Typography sx={{ fontSize: '18px', fontWeight: 600, color: '#6a4c93' }}>{user.user_name}</Typography>
              <Typography sx={{ fontWeight: 400, fontSize: '17px', color: '#4b1d77' }}>{user.userId}</Typography>
              <Typography sx={{ fontSize: '0.875rem', color: '#6a4c93' }}>{user.role}</Typography>
            </Box>

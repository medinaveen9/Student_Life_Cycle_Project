...
const GcPersonalAcademicInfo = () => {
  const data = {
   
    applicationNo: "10003202500015",
    courseCode: "10003",
      dateOfEntry: '12/08/2025',
    lastDate: '21/08/2025',
 courseName:'M.sc Genetic Counselling',
...
export default GcPersonalAcademicInfo;

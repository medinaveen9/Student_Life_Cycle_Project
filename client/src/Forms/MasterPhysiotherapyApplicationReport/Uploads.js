...
const Uploads = () => {
  ...
  'MARKS MEMO OF BPT',
  'PROVISIONAL/FINAL CERTIFICATE OF BPТ',
  'INTERNSHIP CERTIFICATE OF BPT',
  'STUDY AND CONDUCt CERTIFICATE FROM 9th to INTERMEDIATE',
  'STUDY AND CONDUCT CERTIFICATE OF ВPТ',
  'TRANSFER/MIGRATION CERTIFICATE OF BРТ',
  ];
  ...
  <Table>
    <TableBody>
      ...
      <Row label="Internship Date" value={formData.internshipDate} />
           ...
           <Typography variant="subtitle1" sx={{ fontWeight: "bold",fontSize: "1.4rem", mb: 2 }}>
            Correspondence Address</Typography>
          <TableContainer component={Paper} sx={{ mb: 4 }}>
            <Table>
              <TableBody>
